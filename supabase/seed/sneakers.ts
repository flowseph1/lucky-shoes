...
export const sneakersData: Array<InsertSneaker> = [
  {
    ...
    shortDescription:
      "The Air Jordan 1 is a classic sneaker that was first released in 1985.",
  },
  {
    brandId: 1,
  ...
  },
  {
    ...
    shortDescription:
      '"The 2019 edition of the Air Jordan 6 Retro ‘Infrared’ is true to the original colorway',
    longDescription:
      '"The 2019 edition of the Air Jordan 6 Retro ‘Infrared’ is true to the original colorway',
    isAvailable: true,
    isNew: false,
  ...
  },
  {
    ...
    shortDescription:
      '"The Travis Scott x Air Jordan 1 Retro High features a new look on the iconic silhouette',
    longDescription:
      '"The Travis Scott x Air Jordan 1 Retro High features a new look on the iconic silhouette',
    isAvailable: true,
    isNew: true,
  ...
  },
  {
    ...
    shortDescription:
      '"The Air Jordan 1 Retro High OG ‘Crimson Tint’ showcases a simple two-tone design',
    longDescription:
      '"The Air Jordan 1 Retro High OG ‘Crimson Tint’ showcases a simple two-tone design',
    isAvailable: true,
    isNew: true,
  ...
  },
  {
    ...
    shortDescription:
      '"An original colorway of the Air Jordan 11 Low back in 2001',
    longDescription:
      '"An original colorway of the Air Jordan 11 Low back in 2001',
    isAvailable: true,
    isNew: false,
  ...
  },
  {
    ...
    shortDescription:
      '"The Champion Rally Pro sneaker packages street style in a sleek',
    longDescription:
      '"The Champion Rally Pro sneaker packages street style in a sleek',
    isAvailable: true,
    isNew: true,
  ...
  },
  {
    ...
    shortDescription:
      '"This Comme des Garçons x Chuck Taylor All Star Hi features an off-white canvas upper',
    longDescription:
      '"This Comme des Garçons x Chuck Taylor All Star Hi features an off-white canvas upper',
    isAvailable: true,
    isNew: false,
  ...
  },
  {
    ...
    shortDescription:
      '"The Off-White x Air Max 90 ‘Black’ offers a unique blend of materials on the upper',
    longDescription:
      '"The Off-White x Air Max 90 ‘Black’ offers a unique blend of materials on the upper',
    isAvailable: true,
    isNew: true,
  ...
  },
  {
    ...
    shortDescription:
      "\"From streetwear fashion designer Jerry Lorenzo comes the Air Fear of God Moc 'Pure Platinum",
    longDescription:
      "\"From streetwear fashion designer Jerry Lorenzo comes the Air Fear of God Moc 'Pure Platinum",
    isAvailable: true,
    isNew: true,
  ...
  },
  {
    ...
    shortDescription:
      '"With its name coming from the colorway similarities found on the first Yeezy Boost 350 V2',
    longDescription:
      '"With its name coming from the colorway similarities found on the first Yeezy Boost 350 V2',
    isAvailable: true,
    isNew: false,
  ...
  },
  {
    ...
    shortDescription:
      '"This inaugural colorway of Kanye West’s Yeezy Wave Runner 700 launched in November 2017',
    longDescription:
      '"This inaugural colorway of Kanye West’s Yeezy Wave Runner 700 launched in November 2017',
    isAvailable: true,
    isNew: false,
  ...
  },
  {
    ...
    shortDescription:
      '"The Yeezy Boost 350 V2 ‘Static Non-Reflective’ is designed to stand out',
    longDescription:
      '"The Yeezy Boost 350 V2 ‘Static Non-Reflective’ is designed to stand out',
    isAvailable: true,
    isNew: false,
  ...
  },
  {
    ...
    shortDescription:
      '"Kanye West and adidas continued their partnership with the Yeezy Boost 350 V2 ‘Butter',
    longDescription:
      '"Kanye West and adidas continued their partnership with the Yeezy Boost 350 V2 ‘Butter',
    isAvailable: true,
    isNew: false,
  ...
  },
  {
    ...
    shortDescription:
      '"Kanye West’s Yeezy Boost 350 V2 in Semi Frozen Yellow first hit stores in November 2017',
    longDescription:
      '"Kanye West’s Yeezy Boost 350 V2 in Semi Frozen Yellow first hit stores in November 2017',
    isAvailable: true,
    isNew: false,
